...
func listandchange_tls(conn, targetConn net.Conn) {
	for i := 0; i < 50; i++ {
		...
		responseStr = strings.Replace(responseStr, "吴恩达", "yyu", -1)
		responseStr = strings.Replace(responseStr, "Stanford", "SJTU", -1)
		responseStr = strings.Replace(responseStr, "Coursera", "伯禹AI", -1)
...
func handleClient(clientConn net.Conn) {
	...
	listandchange_tls(clientTLS, serverTLS)
